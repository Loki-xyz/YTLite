...
<details>
  ...
  <ol>
    ...
    <li><strong>NOTE:</strong> The file must already be uploaded before you start the workflow. A Filebin <em>bin</em> URL works after the .ipa is in the bin; a Dropbox share link is converted to a direct download. A webpage or empty bin will fail.</li>
...
<details>
  ...
  <ol>
    ...
    <li><strong>NOTE:</strong> The IPA must already be uploaded before you start the workflow. A Filebin <em>bin</em> URL works after the .ipa is in the bin; a Dropbox share link is converted to a direct download. A webpage or empty bin will fail.</li>
    <li>Make sure all inputs are correct, then click <strong>Run workflow</strong> to start the process.</li>
    <li>Wait for the build to finish. You can download the YouTube Plus app from the releases section of your forked repo. (If you can't find the releases section, go to your forked repo and add /releases to the URL, i.e., github.com/user/YTLite/releases.)</li>
  </ol>
</details>
